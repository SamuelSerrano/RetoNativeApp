...
Vue.component('frm-estudiante-component', require('./components/FormEstudiantesComponent.vue').default);
...
Vue.component('frm-curso-component', require('./components/FormCursosComponent.vue').default);
